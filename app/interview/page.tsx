    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-zinc-400 text-sm pl-12">
          AI-driven interview with 5 questions and a full performance evaluation at the end.
        </p>
      </div>
        ...
        <Card glow="violet" className="space-y-6">
          <div>
            ...
            <div className="flex gap-3">
              ...
              />
              <Button size="md" onClick={start} disabled={!role.trim()} className="px-6">
                Start
              </Button>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/8 bg-coal-900 p-4 space-y-2">
            <p className="text-xs font-mono text-zinc-400 uppercase tracking-wide">What to expect</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-2">
              {[
                ...
                <div key={label} className="text-center">
                  <p className="font-display text-xl font-bold text-violet-400">{n}</p>
