    ...
    <div className="surface-card p-8 rounded-2xl shadow-md">
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="inline-flex items-center rounded-full border border-emerald-400/20 bg-emerald-400/10 px-2 py-0.5 text-[10px] font-mono uppercase tracking-wider text-emerald-400">
            Portfolio
          </span>
        </div>
        <p className="text-sm text-zinc-500">
          Get a strong portfolio project idea tailored to your target role and
          existing skills.
        </p>
      </div>
      <ProjectSuggester />
